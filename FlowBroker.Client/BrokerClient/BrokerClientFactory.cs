...
public class BrokerClientFactory
{
    ...
    public IBrokerClient GetClient(
        Action<ServiceCollection> configure = default)
    {
        ...
        Action<ServiceCollection> configure = default)
    {
        ...
        serviceCollection
            .AddSingleton<ISerializedPayloadFactory,
                SerializedPayloadFactory>();
